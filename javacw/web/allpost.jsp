<%-- 
    Document   : allpost
    Created on : Apr 18, 2018, 8:28:28 PM
    Author     : HaShaN
--%>
    ...
    <body>
            ...
            <div class="container">
                ...
                <nav>
                    <ul>
                        ...
                        <li class="current"><a href="posts?filter=all">All Post</a></li>
                        <%
            ...
            <%          
                ...
                if (postListOb != null) {
                    ...
                    for (Post post : posts) {
                        ...
                        if(isAdmin){
                            out.print("<div class=\"delete-btn-div\"><a href=\"javascript:deletePost("+post.getId()+");\"><img src=\"img/delete_icon_inactive.png\" width=\"25\" height=\"25\"></a></div>");
                        }
        ...
        <div style="display: none">
            <div id="propModal" class="modal">
                <form id="frm" action="proposals?filter=all" method="post" enctype="multipart/form-data">
                    <br>
